    ...
    <div className="container mx-auto px-4 py-32 flex flex-col md:flex-row items-center">
      <div className="md:w-1/2 mb-8 md:mb-0">
        ...
        <div className="mt-4 text-center">
          <a href="#" className="text-purple-600 hover:underline">Daftar dengan data diri? Registrasi di sini</a>
          <p className="mt-2">
            Sudah punya akun? <a href="#" className="text-purple-600 hover:underline">Masuk</a>
          </p>
        </div>
      </div>
